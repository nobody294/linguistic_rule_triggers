...
input_csv_dir = "data/statements/combine_negation_active_passive_variants.csv"
output_csv_dir = "data/responses/combine_negation_active_passive_responses_4B_qwen.csv"
