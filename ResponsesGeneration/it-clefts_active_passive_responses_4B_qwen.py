...
input_csv_dir = "data/statements/combine_it-clefts_active_passive_variants.csv"
output_csv_dir = "data/responses/combine_it-clefts_active_passive_responses_4B_qwen.csv"
...
def generate_30_json_responses(model, tokenizer, system_prompt, user_prompt,
