...
files = {
    "original": "data/responses/original_responses_4B_qwen.csv",
    "active_passive": "data/responses/active_passive_responses_4B_qwen.csv",
    "it_cleft": "data/responses/it-clefts_responses_4B_qwen.csv",
    "wh_cleft": "data/responses/wh-clefts_responses_4B_qwen.csv",
    "SVC": "data/responses/SVC_responses_4B_qwen.csv",
    "negation": "data/responses/negation_responses_4B_qwen.csv",
    "opposite": "data/responses/opposite_responses_4B_qwen.csv"
}
