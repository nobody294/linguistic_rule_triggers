...
files = {
    "original": "data/responses/original_responses_14B.csv",
    "active_passive": "data/responses/active_passive_responses_14B.csv",
    "it_cleft": "data/responses/it-clefts_responses_14B.csv",
    "wh_cleft": "data/responses/wh-clefts_responses_14B.csv",
    "SVC": "data/responses/SVC_responses_14B.csv"
}
